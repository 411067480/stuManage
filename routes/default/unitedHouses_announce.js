...
router.get('/',async (ctx)=>{
    ...
    /*获取社联公告所有*/ 
    var allResult = await DB.find('unitedHouses_announce',{},{},{
        page:page,
        pageSize:pageSize,
        sortJson:{
            'u_time':-1  
            //'united_time':-1：倒序排序，最新修改或增加的数据会优先显示在第一条
            //'united_time':1：正序排序，最新修改或增加的数据会优先显示在最后一条
        }
    });
    ...
    ctx.render('default/unitedHouses_announce',{
        nav:nav,
        dataG:a,
        focus:focusResult,
